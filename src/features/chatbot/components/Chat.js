      ...
      <ChatBot
        ...
        steps={[
          ...
          },
          {
            id: "retrun_start",
            message:
              "몇 가지 질문에 답해주시면 당신을 위한 여행 일정이 작성 됩니다.",
            trigger: "start",
          },
          {
            id: "travel",
          ...
          },
          {
            id: "travel_with",
            options: [
              { value: "혼자", label: "혼자", trigger: "output_travel_with" },
              { value: "가족", label: "가족", trigger: "output_travel_with" },
              { value: "친구", label: "친구", trigger: "output_travel_with" },
              { value: "연인", label: "연인", trigger: "output_travel_with" },
