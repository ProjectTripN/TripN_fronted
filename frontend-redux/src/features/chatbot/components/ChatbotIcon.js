...
import stoneBrother from "../images/돌하르방.png";
//Chatbot
...
const ChatBotIcon = ({ license = "", greeting = "", remoteName = "" }) => {
  const some = () => {
        ...
        >
          <ChatContainer>
            <ConversationHeader>
              ...
              <ConversationHeader.Actions>
                ...
                <VoiceCallButton
                  ...
                  onClick={async () => await voice()}
                />
                <VideoCallButton
                  title="Start video call"
                  onClick={async () => await video()}
                />
                <InfoButton
                  title="Show info"
                  onClick={(e) => (window.location.href = "/users/q&a")}
                />
              </ConversationHeader.Actions>
            </ConversationHeader>
            ...
            <img
              ...
              id="voice"
              src={require("../images/60811.png").default}
              alr="button"
            />
            <img
              style={{ display: "", minWidth: "85%", minHeight: "85%" }}
              id="video"
              src={require("../images/vid.gif").default}
            />
