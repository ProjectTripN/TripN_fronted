    ...
    <>
      <div align="center">
        ...
        <div name="departure_plane">
          <Button onClick={() => setDepAirplane(dep_plane1)}>
            <div>
              ...
              <br />
              비행시간: {JSON.parse(
                JSON.stringify(dep_plane1["depPlandTime"])
              )}{" "}
          ...
          <Button onClick={() => setDepAirplane(dep_plane2)}>
            <div>
              ...
              <br />
              비행시간: {JSON.parse(
                JSON.stringify(dep_plane2["depPlandTime"])
              )}{" "}
          ...
          <Button onClick={() => setDepAirplane(dep_plane3)}>
            <div>
              ...
              <br />
              비행시간: {JSON.parse(
                JSON.stringify(dep_plane3["depPlandTime"])
              )}{" "}
        ...
        <div name="activity">
          ...
          <br />
          Activity {activity1["name"]} {activity2["name"]} 이 선택되었습다
